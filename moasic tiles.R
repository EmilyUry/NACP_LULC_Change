...
tile5 <- brick("composite2017tile5.tif")
tile6 <- brick("composite2017tile6.tif")
tile7 <- brick("composite2017tile7-0000000000-0000000000.tif")
tile7a <- brick("composite2017tile7-0000000000-0000006912.tif")
tile8 <- brick("composite2017tile8.tif")
tile10 <- brick("composite2017tile10.tif")
tile11 <- brick("composite2017tile11.tif")
...
writeRaster(m.all, "bothwatersheds.tif", overwrite = T)
